...
from .models import PipelineRead, PipelineUpdate, PipelineCreate, Pipeline, PipelineReadWithService
...
@router.get(
    ...
    response_model=PipelineReadWithService,
)
def get_one(
        pipeline_id: UUID,
...
@router.get(
    ...
    response_model=List[PipelineReadWithService],
)
