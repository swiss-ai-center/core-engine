...
!!! info
    ...
    All following commands are done in the `services/ae-ano-detection/model-servingserving` directory.
...
All environment variables are described in the [`.env`](https://github.com/csia-pme/csia-pme/blob/main/services/ae-ano-detection/model-servingserving/.env) file.
...
In the `ae-ano-detection/model-servingserving` directory, start the service with the following commands.
...
In the `ae-ano-detection/model-servingserving` directory, build the Docker image with the following commands.
