...
The goal of this step is to serve the model made in the previous step. All further commands are ran in the `model-servingserving` directory.
...
All environment variables are described in the [`.env`](https://github.com/csia-pme/csia-pme/blob/main/services/digit-recognition/model-servingserving/.env) file.
...
In the `services/digit-recognition/model-servingserving` directory, start the service with the following commands.
...
In the `digit-recognition/model-servingserving` directory, start the service with the following commands.
...
In the `digit-recognition/model-servingserving` directory, build the Docker image with the following commands.
