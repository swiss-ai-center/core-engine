...
export const systemColorModeToLightOrDark = (systemColorMode: string): "light" | "dark" | "system" => {
  if (systemColorMode === "light" || systemColorMode === "dark") {
    return systemColorMode;
  } else if (systemColorMode === "system") {
