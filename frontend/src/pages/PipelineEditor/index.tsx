      ...
      <Box component={"main"} sx={{flexGrow: 1, mb: 0}}>
        ...
        <Container maxWidth={false}>
          ...
          <Grid container spacing={2} justifyContent={"flex-start"} sx={{height: "100%"}}
                alignItems={"stretch"}>
            <Grid container justifyContent={"flex-start"} spacing={2} size={{xs: 12, md: 6}}
                  alignItems={"stretch"}>
              <Grid container spacing={2} justifyContent={"space-between"}>
              ...
              <Grid alignContent={"flex-end"} flexDirection={"column"} size={{xs: 12}}>
            ...
            <Grid pl={2} pt={2} container alignItems={"stretch"} size={{xs: 12, md: 6}}>
