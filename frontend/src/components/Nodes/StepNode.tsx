...
import { displayTimer, download, positionHandle, systemColorModeToLightOrDark } from 'utils/functions';
  ...
  return (
    <>
      ...
      <div className="handles targets">
        {data.targetHandles.map((handle: any, index: number) => {
          return (
            <CustomHandle
              key={index}
              id={handle.id}
      ...
      <div className="handles sources">
        {data.sourceHandles.map((handle: any, index: number) => {
          return (
            <CustomHandle
              key={index}
              id={handle.id}
