...
import { ElkNode } from 'models/NodeData';
...
import { Background, Controls, Edge, ReactFlow, useEdgesState, useNodesState, useReactFlow, } from '@xyflow/react';
...
const Board: React.FC<{ description: any }> = ({description}) => {
  ...
  // v12: do not pass generics to useReactFlow — types are inferred
